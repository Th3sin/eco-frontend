...
export const tipoResiduo = [ 
  ...
  "Borracha", "Alumínio", "Isopor", "Óleo de Cozinha", 
  "Resíduos de Construção Civil", "Resíduos Industriais", 
...
export const materiais = {
    ...
    Hospitalar: [
        ...
        "Fraldas hospitalares", "Bolsas de sangue", "Sacos de soro", "Termômetros descartáveis", 
        "Eletrodos descartáveis", "Papel toalha", "Toalhas descartáveis", "Medicamentos", 
        "Resíduos de exames", "Tecidos", "Produtos de higiene", "Resíduos de produtos odontológicos", 
        "Frascos de vidro quebrados", "Sacos de lixo infectantes"
    ],
    Entulhos: [
        "Tijolos", "Sobras de material", "Entulhos", "Amianto", "Cerâmicas", "Fios e cabos elétricos"
    ],
    Têxteis: [
        "Tecidos", "Roupas", "Retalhos de tecido", "Fios têxteis"
    ]
