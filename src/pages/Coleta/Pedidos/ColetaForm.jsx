...
function ColetaForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Redireciona para o formulário completo, levando os dados
    navigate('/SolicitarColeta', { state: { formData } });
  };

  return (
    <div className="container-solicitacao-resumido">
      <form onSubmit={handleSubmit}>

        <div className="resumo-coleta-form-group">
          <label>Nome</label>
          <input type="text" name="nome" placeholder="Digite seu nome" required value={formData.nome} onChange={handleInputChange}
          />
        </div>
        ...
        <div className="resumo-coleta-form-group">
  <label htmlFor="classeResiduo">Resíduo</label>
  <select name="classeResiduo" id="classeResiduo">
